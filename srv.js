...
const g = {
    tsdUrlCapTok: "https://data.tsd.usit.no/all/auth/instances/token",
    tsdUrlUpload: `https://data.tsd.usit.no/${process.env.TSD_PROJECT}/files/stream/${process.env.TSD_GROUP}/${process.env.REMOTE_DIR}`,
